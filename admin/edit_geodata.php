...
$qb=mysqli_query($con,"update geodata set place='$place',pg='$pg',ff='$ff',ch='$ch',mq='$mq',ms='$ms',mk='$mk',ss='$ss',cl='$cl',sc='$sc',qt='$qt',hs='$hs',sr='$sr',ht='$ht',hp='$hp',date='$date' where id='$id'");
if($qb){
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Edit Geo-data</a></li>
                                ...
                                <div class="basic-form">
                                    <form action="#" method="POST">
                                        <div class="container">
                                            ...
                                            <input type="text" class="form-control input-rounded" name="place" placeholder="Please enter name of place" value="<?php echo $r['place']; ?>" required="required">
                                        </div>
                                                </div>
                                            ...
                                            <input type="number" class="form-control input-rounded" name="pg" value="<?php echo $r['pg']; ?>" required="required">
                                        </div>
                                                </div>
                                            ...
                                            <input type="number" class="form-control input-rounded" name="ms" value="<?php echo $r['ms']; ?>"  required="required">
                                        </div>
                                                </div>
                                            ...
                                            <input type="number" class="form-control input-rounded" name="ss" value="<?php echo $r['ss']; ?>" required="required">
                                        </div>
                                                </div>
                                            ...
                                            <input type="number" class="form-control input-rounded" name="qt" value="<?php echo $r['qt']; ?>" required="required">
                                        </div>
                                                </div>

...
$q3=mysqli_query($con,"select * from geodata  ");
                        ...
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                   <a href="view.php"> <span><i class="fa fa-book f-s-50 color-primary"></i></span></a>
                                </div>
                                <div class="media-body media-text-right">
                                    ...
                                    <p class="m-b-0"><a href="view.php">Total Geo-Data</a></p>
                                </div>
                            </div>
                        </div>
                    </div>

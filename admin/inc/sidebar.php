 <div class="left-sidebar">
    ...
    <?php
include '../config.php';
$qt=mysqli_query($con,"select * from admin_login where email='".$_SESSION['email']."'");
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-map-marker"></i><span class="hide-menu">Geo-data </span></a>
                            <ul aria-expanded="false" class="collapse">
                               <li><a href="add.php">Add Geo-data</a></li>
                                <li><a href="view.php">View Geo-data</a></li>
...
<ul aria-expanded="false" class="collapse">
                        ...
                        <li> <a href="logout.php" aria-expanded="false"><i class="fa fa-sign-out"></i><span class="hide-menu">Logout</span></a>
